...
def get_gemini_summary(news_list):
    if not GEMINI_API_KEY: 
        print("❌ 錯誤：無 API Key"); return None
    ...
    try:
        ...
        for model_name in ["gemini-2.0-flash", "gemini-2.0-flash-lite", "gemini-1.5-flash"]:
            try:
                ...
                print(f"⚠️ {model_name} Error: {e}"); continue
        return "❌ AI 暫時無法回應 (Busy)"
    except Exception as e:
        print(f"AI Critical Error: {e}"); return None
